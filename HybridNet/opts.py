...
def parse_opt():
    ...
    parser.add_argument(
        '--info_json',
        type=str,
        default='./HybridNet/data/v2c_info.json',
        help='path to the json file containing additional info and vocab')

    parser.add_argument(
        '--cap_info_json',
        type=str,
        default='./HybridNet/data/msrvtt_new_info.json',
        help='path to the json file containing additional info and vocab')
    ...
    parser.add_argument(
        ...
        default='./HybridNet/data/caption_new1.json',
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=str,
        default=['./HybridNet/data/feats/resnet152'],
        # default=['C:/resnet152'],
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=str,
        default=['./HybridNet/data/i3d_features'],
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=str,
        default=['./HybridNet/data/audio_features'],
    ...
    parser.add_argument(
        ...
        type=int,
        default = -1,
        help='ix of the video to be tested')
    ...
    parser.add_argument(
        '--checkpoint_path',
        type=str,
        default='./HybridNet/save',
        help='directory to store check pointed models')

    parser.add_argument(
        '--output_dir',
        type=str,
        default='./HybridNet/save/cms',
    ...
    parser.add_argument(
        '--load_checkpoint',
        type=str,
        default='./HybridNet/save/cms/cms_560.pth',
    ...
    parser.add_argument(
        '--cms',
        #增加need，react
        choices=['int', 'eff', 'att', 'need', 'react'],
        default='int',
